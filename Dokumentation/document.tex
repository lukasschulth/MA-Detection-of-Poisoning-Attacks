...
\begin{document}
	...
	\begin{proposition}
		...
		\begin{equation}
		\forall (i,j) \in \lbrace 1,...,n \rbrace \times \lbrace 1,...,m \rbrace : \boldsymbol{P}_{i,j} = \boldsymbol{u}_i \boldsymbol{K}_{i,j} \boldsymbol{v}_j
		\end{equation}
	...
	n\_samples\_bary: 10
	iter: 0
	(tn, fp, fn, tp): 1650,0,491,322
	iter: 1
	(tn, fp, fn, tp): 449,1201,802,11
	iter: 2
	(tn, fp, fn, tp): 1650,0,32,781
	iter: 3
	(tn, fp, fn, tp): 1621,29,27,786
	iter: 4
	(tn, fp, fn, tp): 1632,18,27,786
	acc = 98.17
	tpr = 96.98
	tnr = 98.91
