    ...
    def evaluate_ai(self, verbose=True):
        ...
        if verbose:
            ...
            if self.model.poisoned_data:
                ...
                #print('ASR: ', self.model.BDSR_classwise[2])

                self.model.bdsr = self.model.BDSR_classwise[2] # Eigentlich sollte die zweit durch target_class ersetzt werden
                ...
                self.model.GUD = pred_correct.__round__(3) * 100
