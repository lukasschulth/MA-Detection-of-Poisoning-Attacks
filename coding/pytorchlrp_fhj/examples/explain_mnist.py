...
from coding.pytorchlrp_fhj.examples.utils import get_mnist_model, prepare_mnist_model, get_mnist_data
from coding.pytorchlrp_fhj.examples.utils import store_patterns, load_patterns
