...
from coding.testest.inverter_util import RelevancePropagator
from coding.testest.utils import pprint, Flatten
...
class InnvestigateModel(torch.nn.Module):
    ...
    def evaluate(self, in_tensor):
        ...
        # TODO: #self.prediction, _ = self.model(in_tensor) abgeändert zu
        self.prediction, _ = self.model(in_tensor)
