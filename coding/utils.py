...
def loadparams():
    W = [numpy.loadtxt('params_l%d-W.txt'%l) for l in range(1,4)]
    B = [numpy.loadtxt('params_l%d-B.txt'%l) for l in range(1,4)]
    return W, B
...
def loaddata():
    X = numpy.loadtxt('/coding/X.txt')
    T = numpy.loadtxt('/coding/T.txt')
    return X,T
